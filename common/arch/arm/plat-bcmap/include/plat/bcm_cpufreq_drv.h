...
struct bcm_cpu_info {
	...
	char *appspll_en_clk;
	/* Index of makwuz mode cpu frequency in the DVFS table. Switching
	 * to makwuz mode needs special handling.
	 */
	int index_makwuz; //add eve oc
	/* Index of ngenos mode cpu frequency in DVFS table. */
	int index_ngenos; //add eve oc
	/* Index of turbo mode cpu frequency in DVFS table. */
	int index_turbo;
	/* Index of kenceng mode cpu frequency in DVFS table. */
	int index_kenceng; //add eve oc
	/* Index of kebut mode cpu frequency in DVFS table. */
	int index_kebut; //add eve oc
	/* Index of normal mode cpu frequency in DVFS table. */
	int index_normal; //add eve oc
	/* Index of lelet mode cpu frequency in DVFS table. */
	int index_lelet; //add eve oc
	/* Index of lemot mode cpu frequency in DVFS table. */
	int index_lemot; //add eve oc
};
