 ...
 */
enum {
	BCM21553_CORECLK_KHZ_104 = (104U * 1000), //add eve oc
	BCM21553_CORECLK_KHZ_156 = (156U * 1000), //add eve oc
	BCM21553_CORECLK_KHZ_312 = (312U * 1000),
	BCM21553_CORECLK_KHZ_468 = (468U * 1000), //add eve oc
	BCM21553_CORECLK_KHZ_624 = (624U * 1000), //add eve oc
	BCM21553_CORECLK_KHZ_832 = (832U * 1000),
	BCM21553_CORECLK_KHZ_936 = (936U * 1000), //add eve oc
	BCM21553_CORECLK_KHZ_1GB = (1248U * 1000), //add eve oc
};

struct bcm21553_cpufreq_gov_plat {
	unsigned int freq_makwuz; //add eve oc
	unsigned int freq_ngenos; //add eve oc
	unsigned int freq_turbo;
	unsigned int freq_kenceng; //add eve oc
	unsigned int freq_kebut; //add eve oc
	unsigned int freq_normal;
	unsigned int freq_lelet; //add eve oc
	unsigned int freq_lemot; //add eve oc
};
